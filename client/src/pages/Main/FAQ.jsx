    ...
    items: [
      {
        ...
        a: (
          <ol className="list-decimal pl-5 space-y-2">
            <li><strong>Browse &amp; Select</strong> — Find the outfit you love and choose your event date.</li>
            <li><strong>Pay Advance + Rental Amount</strong> — At checkout you pay the <em>rental fee</em> plus a <em>refundable security deposit (advance)</em>.</li>
            <li><strong>Delivery to Your Door</strong> — We clean, pack, and deliver the outfit to your address before your event.</li>
            <li><strong>Wear &amp; Enjoy</strong> — Look stunning at your event!</li>
            <li><strong>We Pick It Up</strong> — Once your rental period ends, we schedule a pickup from your location.</li>
            <li><strong>Advance Returned</strong> — After the garment passes inspection, your full security deposit is refunded within 3–5 business days.</li>
          </ol>
        ),
      },
      {
    ...
    items: [
      {
        ...
        a: (
          <div className="space-y-3">
            <div>
              <p className="font-semibold text-green-700">✅ Normal wear (no deduction):</p>
            ...
            <div>
              <p className="font-semibold text-red-600">❌ Damage (advance deducted):</p>
              <ul className="list-disc pl-5 space-y-1 text-neutral-600">
                <li>Food, beverage, makeup, or oil stains that require special treatment.</li>
                <li>Tears, rips, burns, or cuts to the fabric.</li>
                <li>Missing embellishments, buttons, or dupatta.</li>
                <li>Alterations, stitching, or dyeing done without permission.</li>
              </ul>
            </div>
          </div>
        ),
        ...
        a: (
          <div className="space-y-2">
            ...
            <div className="space-y-1.5">
              {[
                { when: '7+ days before delivery', refund: '100% refund', color: 'text-green-700 bg-green-50 border-green-200' },
                { when: '3–6 days before delivery', refund: '50% refund', color: 'text-yellow-700 bg-yellow-50 border-yellow-200' },
                { when: '1–2 days before delivery', refund: '25% refund', color: 'text-orange-700 bg-orange-50 border-orange-200' },
                { when: 'Same day / after dispatch', refund: 'No refund', color: 'text-red-700 bg-red-50 border-red-200' },
              ].map((r) => (
                <div key={r.when} className={`flex justify-between border rounded-lg px-4 py-2 text-sm ${r.color}`}>
                  <span>{r.when}</span>
                  <span className="font-semibold">{r.refund}</span>
                </div>
              ))}
            </div>
            <p className="text-sm text-neutral-500">See our full <Link to="/refund" className="text-pink-600 hover:underline">Refund Policy</Link> for details.</p>
          </div>
        ),
      },
      {
      ...
      },
      {
        ...
        a: (
          <ul className="space-y-1">
            ...
            <li>💬 <a href="https://wa.me/918431094754" target="_blank" rel="noreferrer" className="text-pink-600 hover:underline">WhatsApp us</a></li>
    ...
    <div className="border-b border-neutral-200 last:border-0">
      ...
      <AnimatePresence initial={false}>
        {open && (
          ...
          >
            <div className="pb-5 text-neutral-600 text-sm leading-relaxed">{a}</div>
          </motion.div>
        )}
      </AnimatePresence>
    </div>
...
const FAQ = () => {
  ...
  return (
    ...
    >
      {/* Header */}
      <div className="bg-black text-white py-16 px-4 rounded-b-3xl text-center">
        <p className="text-pink-400 text-xs font-semibold uppercase tracking-widest mb-2">Help Centre</p>
        <h1 className="text-4xl font-bold">Frequently Asked Questions</h1>
        <p className="mt-3 text-neutral-400 max-w-lg mx-auto text-sm">
          Everything you need to know about renting from People &amp; Style — from placing your order to getting your advance back.
        </p>
      </div>
      ...
      <div className="max-w-5xl mx-auto px-4 py-14 grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div className="md:col-span-3">
          {faqs
            ...
            .map((group) => (
              <div key={group.category} className="bg-white border rounded-2xl px-6 py-2 shadow-sm">
                <h2 className="text-lg font-bold py-5 border-b border-neutral-100">{group.category}</h2>
      ...
      <div className="bg-black text-white rounded-t-3xl py-14 px-4 text-center mt-4">
        <h2 className="text-2xl font-bold mb-2">Still have questions?</h2>
        <p className="text-neutral-400 text-sm mb-6">Our team is happy to help. Reach out anytime.</p>
