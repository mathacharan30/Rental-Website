        ...
        >
          ...
          <div className="mt-8 flex gap-3">
            <button
              ...
              className="relative group/btn overflow-hidden shadow-inner shadow-white border-b  border-violet-500/40 bg-violet-600 text-violet-200 hover:text-white font-semibold py-3.5 px-6 rounded-full hover:border-violet-400 hover:bg-violet-600 transition-all duration-300 flex-1 min-w-0 flex items-center justify-center gap-2"
            >
