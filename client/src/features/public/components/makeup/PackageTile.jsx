...
const PackageTile = ({ pkg, onClick }) => {
  ...
  return (
    <motion.div
      ...
      onClick={() => onClick(pkg)}
      className="group relative cursor-pointer w-42 md:w-56 overflow-hidden rounded-3xl border-y-2 border-white/8 bg-white/2 backdrop-blur-md shadow-lg shadow-black/25 hover:bg-white/5 hover:shadow-violet-950/20 hover:shadow-xl transition-all duration-500 mb-6 block p-1.5 md:p-2.5"
    >
