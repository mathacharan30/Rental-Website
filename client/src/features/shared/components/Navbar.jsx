    ...
    >
      <div
        className={`max-w-7xl mx-auto rounded-full border transition-all duration-300 ${
          scrolled
            ? "border-white/12 bg-gradient-to-r from-[#0a0a0a]/88 via-[#111111]/84 to-[#0a0a0a]/88 shadow-[#010101] shadow-2xl backdrop-blur-xl"
            : "border-white/8 bg-gradient-to-r from-[#0a0a0a]/78 via-[#121212]/74 to-[#0a0a0a]/78 shadow-[#0a0a0a] shadow-lg backdrop-blur-xl"
        }`}
      >
